package uk.ac.cam.lib.spring.security.raven.vedorised;

// This class has been vendorised here as it's package-private in Spring, and is
// required to adapt SavedRequest to a ServletHttpRequest.
// RequestCache.getMatchingRequest() is the only way to perform the adaptation,
// and it has the unwanted side-effect of removing the cached request.
